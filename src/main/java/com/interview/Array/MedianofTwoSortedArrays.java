...
public class MedianofTwoSortedArrays {
	...
	public static int getMedian(int ar1[], int ar2[]) {
		...
		if (m1 < m2) {
			if (n % 2 == 0)
				return getMedian(Arrays.copyOfRange(ar1, ar1.length/2 -1 ,ar1.length), 
								Arrays.copyOfRange(ar2, 0, ar2.length/2+1));
			return getMedian(Arrays.copyOfRange(ar1, ar1.length/2 ,ar1.length), 
					Arrays.copyOfRange(ar2, 0, ar2.length/2+1));
		}
		 ...
		 */
		if (n % 2 == 0)
			return getMedian(Arrays.copyOfRange(ar1, 0 ,ar1.length/2+1), 
					Arrays.copyOfRange(ar2, ar2.length/2-1, ar2.length));
		return getMedian(Arrays.copyOfRange(ar1, 0 ,ar1.length/2+1), 
				Arrays.copyOfRange(ar2, ar2.length/2, ar2.length));
	}
