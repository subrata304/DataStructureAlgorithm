...
public class LongestNonRepeatingSubstring {
	...
	/*
	 * Time Complexity: O(n + d) where n is length of the input string 
	 * and d is number of characters in input string alphabet. For example, 
	 * if string consists of lowercase English characters then value of d is 26.
	 * Auxiliary Space: O(d)
	 */
