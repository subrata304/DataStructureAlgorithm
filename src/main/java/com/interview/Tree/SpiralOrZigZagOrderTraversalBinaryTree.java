 ...
 */
public class SpiralOrZigZagOrderTraversalBinaryTree {
	 ...
	 */
	public static void spiralWithTwoStack(Node root) {
		if (root == null) {
			return;
		}
	 ...
	 */
	public static void spiralWithOneDeque(Node root) {
		if (root == null) {
			return;
		}
	 ...
	 */
	public static void spiralWithOneDequeDelimiter(Node root) {
		if (root == null) {
			return;
		}
	...
	public static void main(String args[]) {
		...
		spiralWithTwoStack(tree.root);
		System.out.println("\nOne deque with count");
		spiralWithOneDeque(tree.root);
		System.out.println("\nOne deque with delimiter");
		spiralWithOneDequeDelimiter(tree.root);
	}
}
